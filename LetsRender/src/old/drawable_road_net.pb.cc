...
void RoadClassMessage::SharedCtor() {
  ...
  s1_ = 0;
  v1_ = 0;
  road_class_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  lanes_ = 0;
  surface_ = NULL;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
void RoadClassMessage::SharedDtor() {
  if (road_class_ != &::google::protobuf::internal::kEmptyString) {
    delete road_class_;
  }
  if (this != default_instance_) {
    delete surface_;
...
void RoadClassTupleMessage::SharedCtor() {
  _cached_size_ = 0;
  road_class_name_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  road_class_ = NULL;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
void RoadClassTupleMessage::SharedDtor() {
  if (road_class_name_ != &::google::protobuf::internal::kEmptyString) {
...
bool SumoRoadNetworkMessage::IsInitialized() const {
  ...
  for (int i = 0; i < tuples_size(); i++) {
    if (!this->tuples(i).IsInitialized()) return false;
  }
  return true;
}
